...
function populateTable() {
  ...
  $.getJSON( '/guns/gunlist', function( data ) {
    ...
    $.each(data, function(){
      ...
      tableContent += '<td><button class="btn btn-warning" id="'+this.number+'" onclick="showModal(this.id)">Details</button><button class="btn btn-primary" onclick="addCart()">Add to cart</button></td>';
      tableContent += '</tr>';
    });
